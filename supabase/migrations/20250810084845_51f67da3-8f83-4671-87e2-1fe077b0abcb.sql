-- Secure RLS and policies migration (idempotent)

-- Helper function: enable RLS and create policy only if table/policy exists/missing
-- Achievements
DO $$
BEGIN
  IF EXISTS (
    ...
    IF NOT EXISTS (
      ...
      WHERE schemaname = 'public' AND tablename = 'achievements' AND polname = 'achievements_select_authenticated'
    ) THEN
...
BEGIN
  IF EXISTS (
    ...
    IF NOT EXISTS (
      SELECT 1 FROM pg_policies 
      WHERE schemaname = 'public' AND tablename = 'content_tags' AND polname = 'content_tags_select_authenticated'
    ) THEN
...
BEGIN
  IF EXISTS (
    ...
    IF NOT EXISTS (
      SELECT 1 FROM pg_policies 
      WHERE schemaname = 'public' AND tablename = 'content_tag_mappings' AND polname = 'content_tag_mappings_select_authenticated'
    ) THEN
...
BEGIN
  IF EXISTS (
    ...
    IF NOT EXISTS (
      SELECT 1 FROM pg_policies 
      WHERE schemaname = 'public' AND tablename = 'content_language' AND polname = 'content_language_select_authenticated'
    ) THEN
...
BEGIN
  IF EXISTS (
    ...
    IF NOT EXISTS (
      SELECT 1 FROM pg_policies 
      WHERE schemaname = 'public' AND tablename = 'analytics_events' AND polname = 'analytics_events_select_own'
    ) THEN
      EXECUTE 'CREATE POLICY "analytics_events_select_own" ON public.analytics_events FOR SELECT USING (auth.uid() = user_id)';
    END IF;
    IF NOT EXISTS (
      SELECT 1 FROM pg_policies 
      WHERE schemaname = 'public' AND tablename = 'analytics_events' AND polname = 'analytics_events_insert_own'
    ) THEN
...
BEGIN
  IF EXISTS (
    ...
    IF NOT EXISTS (
      SELECT 1 FROM pg_policies 
      WHERE schemaname = 'public' AND tablename = 'content_flags' AND polname = 'content_flags_select_own'
    ) THEN
      EXECUTE 'CREATE POLICY "content_flags_select_own" ON public.content_flags FOR SELECT USING (auth.uid() = flagged_by)';
    END IF;
    IF NOT EXISTS (
      SELECT 1 FROM pg_policies 
      WHERE schemaname = 'public' AND tablename = 'content_flags' AND polname = 'content_flags_insert_own'
    ) THEN
...
BEGIN
  IF EXISTS (
    ...
    IF NOT EXISTS (
      SELECT 1 FROM pg_policies 
      WHERE schemaname = 'public' AND tablename = 'matching_results' AND polname = 'matching_results_select_own'
    ) THEN
      EXECUTE 'CREATE POLICY "matching_results_select_own" ON public.matching_results FOR SELECT USING (auth.uid() = user_id)';
    END IF;
    IF NOT EXISTS (
      SELECT 1 FROM pg_policies 
      WHERE schemaname = 'public' AND tablename = 'matching_results' AND polname = 'matching_results_insert_own'
    ) THEN
...
BEGIN
  IF EXISTS (
    ...
    IF NOT EXISTS (
      SELECT 1 FROM pg_policies 
      WHERE schemaname = 'public' AND tablename = 'profiles' AND polname = 'profiles_select_authenticated'
    ) THEN
