...
const categories = ["All", "Career", "Mentorship", "Networking", "Education", "Philanthropy", "Alumni Spotlight", "Events"];
const BlogPage = () => {
  ...
  return <div className="min-h-screen flex flex-col">
      ...
      <main className="flex-grow py-16 px-4 md:px-8 bg-green-50">
        <div className="max-w-7xl mx-auto">
          ...
          {/* Featured Posts */}
          {featuredPosts.length > 0 && <div className="mb-12">
              ...
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                {featuredPosts.map(post => <div key={post.id} className="rounded-lg overflow-hidden shadow-md hover:shadow-lg transition-all duration-300 hover:translate-y-[-5px] bg-lime-50">
                    ...
                    <div className="p-6">
                      ...
                      <div className="mt-4 flex justify-between items-center pt-4 border-t border-gray-100">
                        ...
                        <Button variant="ghost" className="text-nexus-primary hover:text-nexus-primary/90 p-0" onClick={() => navigate(`/blog/${post.id}`)}>
                          Read more
          ...
          <div className="mb-8">
            <div className="flex flex-col md:flex-row gap-4 items-center justify-between mb-6">
              <div className="relative w-full md:w-80">
                ...
                <Input placeholder="Search articles..." value={searchQuery} onChange={e => setSearchQuery(e.target.value)} className="pl-10 bg-sky-100" />
              </div>
              
              <div className="flex gap-2 overflow-x-auto w-full md:w-auto pb-2 md:pb-0 bg-transparent">
                {categories.map(category => <Button key={category} variant={activeCategory === category ? "default" : "outline"} className={activeCategory === category ? "bg-nexus-primary hover:bg-nexus-primary/90" : "hover:bg-gray-100"} onClick={() => setActiveCategory(category)}>
                    {category}
                  </Button>)}
              </div>
            </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-12">
            {filteredPosts.length > 0 ? filteredPosts.map(post => <div key={post.id} className="bg-white border border-gray-100 rounded-lg overflow-hidden shadow-sm hover:shadow-md transition-all duration-300 hover:translate-y-[-5px] flex flex-col" onClick={() => navigate(`/blog/${post.id}`)}>
                  ...
                  <div className="p-5 flex-1 flex flex-col bg-lime-50">
                    ...
                    <div className="mt-auto">
                      ...
                      <div className="flex justify-between items-center pt-3 border-t border-gray-100">
                        ...
                        <Button variant="ghost" size="sm" className="text-nexus-primary hover:text-nexus-primary/90 p-0 h-auto">
                          Read more
          ...
          <div className="bg-nexus-primary/10 rounded-lg p-8 text-center">
            ...
            <div className="flex flex-col sm:flex-row gap-3 justify-center max-w-md mx-auto">
              <Input placeholder="Your email address" className="bg-fuchsia-50" />
