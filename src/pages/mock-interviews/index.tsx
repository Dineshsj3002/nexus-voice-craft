        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="mb-16">
            ...
            <MockInterviewCard 
              ...
              description={featuredInterview.description}
              image={featuredInterview.image}
              duration={featuredInterview.duration}
              category={featuredInterview.category}
              featured={true}
            />
          </div>
                  ...
                  <div className="flex h-full">
                    ...
                    <CardContent className="w-2/3 p-4">
                      ...
                      <Button 
                        ...
                        size="sm" 
                        className="mt-auto"
                        onClick={() => showSuccessToast({ message: `Selected ${type.title}`, emoji: '✅' })}
                      >
                        Select
